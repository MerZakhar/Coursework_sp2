...
#define TOKENS_RE         "\\||<|>|;|:|!=|&|->|\\+\\+|--|,|\\*\\*|==|!|Div|Mod|\\[|\\]|\\(|\\)|\\{|\\}|[_#0-9A-Za-z]+|[^ \t\r\f\v\n]"
#define KEYWORDS_RE       ";|->|\\+\\+|--|\\*\\*|,|==|!=|:|\\[|\\]|\\(|\\)|\\{|\\}|#Program|Variable|Start|Stop|Read|Write|If|Else|For|Downto|Do|Div|Mod|<|>|!|&|\\||Integer_2"
#define IDENTIFIERS_RE    "_[0-9][A-Z][A-Z]"
...
#define DEFAULT_INPUT_FILE "file1.m12"
